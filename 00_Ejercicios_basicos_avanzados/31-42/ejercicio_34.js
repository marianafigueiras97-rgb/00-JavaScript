...
function averageMovieDuration(movies) {
  ...
  for (let i = 0; i < movies.length; i++) {
    totalMinutes = totalMinutes + movies[i].duration
  }

  let average = totalMinutes / movies.length;
  console.log(`El total de duración es ${totalMinutes} y promedio de duracion es ${average}`);
}
